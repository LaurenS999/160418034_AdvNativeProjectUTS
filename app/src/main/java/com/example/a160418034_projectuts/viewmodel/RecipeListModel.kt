...
class RecipeListModel: ViewModel()  {
    ...
    fun refresh() {
        val Recipe1 = Recipe("1", "Basmati Rice and Turkey Stuffed Peppers","Nasi",
                " 1 ½ cups water\n" +
        ...
        val Recipe2 = Recipe("2", "Nasi Goreng Chinese","Nasi",
                ...
                "http://dummyimage.com/75x100.jpg/5fa2dd/ffffff",0)
        val Recipe3 = Recipe("3", "Pollo alla Birra for Two","Ayam",
                ...
                1)
        val Recipe4 = Recipe("4", "Black Rice","Nasi",
        ...
        val Recipe5 = Recipe("5", "Hunter Style Chicken","Ayam",
        ...
        val RecipeList:ArrayList<Recipe> = arrayListOf<Recipe>(Recipe1, Recipe2, Recipe3,Recipe4,Recipe5)
